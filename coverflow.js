...
function coverflowimages(options) {
	...
	for (var i = 0; i < options.images.length; i++) {
		...
		frameinnerHTML += '<li><img src="' + options.images[i][0] + '" alt=""></li>\n';
	}
	...
	$frame.on('mousedown', function (e) {
		if ($(e.target).is('img')) {
			activeitem = $(e.target).closest('li').index();
		}
	});
...
coverflowimages({
	coverid: 'coverflow1',
	images: [
		['/IMG/img1.jpg', '/IMG/img1_large.jpg', 'Description 1'],
		['/IMG/img2.jpeg', '/IMG/img2_large.jpg', 'Description 2'],
		['/IMG/img3.webp', '/IMG/img3_large.jpg', 'Description 3']
		// Add more images with the format ['image_small.jpg', 'image_large.jpg', 'Description']
	]
});
